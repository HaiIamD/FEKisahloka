...
function Beranda() {
  ...
  const backgroundImageUrl = 'assets/herosection.png';
          ...
          <div className="stickBeranda">
            ...
            >
              ...
              <div className="d-flex flex-wrap" target="_blank" rel="noopener noreferrer">
                <a href="https://www.youtube.com/channel/UCdq4iT_AZwMQCMTr1A-uXFw" className="borderIcon">
                  <FaYoutube size={25} color="1a3a5c" />
                </a>
                <a href="https://www.youtube.com/channel/UCdq4iT_AZwMQCMTr1A-uXFw" className="borderIcon" target="_blank" rel="noopener noreferrer">
